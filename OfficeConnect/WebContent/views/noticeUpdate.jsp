...
NoticeVO vo = (NoticeVO) request.getAttribute("nv");
vo.setNtcCont(vo.getNtcCont().replace("<br>","\r\n"));
%>
<!DOCTYPE html>
<html lang="ko">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
         ...
         <div id="content">
            ...
            <div class="container-fluid">
               <form atcion="<%=request.getContextPath()%>/notice/update.do"
                  method="post">
                  <!-- 페이지 내 헤더 -->
