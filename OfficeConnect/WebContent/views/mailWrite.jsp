								...
								<div class="col-lg-10">
									...
									<form action="../mail/sendList.do" method="post" enctype="multipart/form-data">
										...
										<div class="mb-3" style="width: 60%; display: flex; align-items: center;">
											...
											<input type="email" class="form-control" id="recipient" name="address" style="flex: 3; margin-right: 10px;">
										...
										<div class="mb-3">
											...
											<textarea class="form-control" id="message" name="body" rows="12" required></textarea>
										</div>
