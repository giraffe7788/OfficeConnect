        ...
        <div id="loginRight">
            ...
            <form onsubmit="loginCheck()" id="login">
                <div class="loginBox">
                    ...
                    <input type="text" id="idCheck" name="mail" placeholder="사번" />
                </div>
                <div class="loginBox">
                    <i disabled class="fas fa-lock"></i>
                    <input type="password" id="pwCheck" name="pass" placeholder="비밀번호" />
                </div>
                
                <div id="loginBox2">
                    <input type="checkbox" id="idchk" name="auto" value="remember"/><span class="purple">내 정보 기억하기</span>
